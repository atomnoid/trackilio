...
export function PlaceCard({ listPlace, currentUserId, canEdit = false }: PlaceCardProps) {
    ...
    <>
      ...
      {canEdit && (
        <EditPlaceModal
          ...
          initialNote={listPlace.note}
          initialPriority={listPlace.priority}
          initialStatus={listPlace.status}
          initialMapsUrl={place?.maps_url}
