...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-20 sm:space-y-28 pb-24 overflow-x-hidden bg-[#FAF3E1]">
        ...
        <div className="rounded-3xl bg-[#F5E7C6] border border-[#E8DECA] p-8 sm:p-14 text-center space-y-8">
          <div className="max-w-2xl mx-auto space-y-3">
            ...
            <p className="text-sm text-[#6B6862] leading-relaxed">
              From seeing a spot on social media to walking through its doors with friends.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-left">
            <div className="bg-[#FAF3E1] p-6 rounded-2xl border border-[#E8DECA] space-y-2">
              <div className="text-2xl font-black text-[#FA8112]">01</div>
              <h3 className="font-sans text-base font-extrabold text-[#222222]">Curate</h3>
              <p className="text-xs text-[#6B6862]">
                Save places you discover with notes, priority levels, and locations.
              </p>
            </div>

            <div className="bg-[#FAF3E1] p-6 rounded-2xl border border-[#E8DECA] space-y-2">
              <div className="text-2xl font-black text-[#FA8112]">02</div>
              <h3 className="font-sans text-base font-extrabold text-[#222222]">Organize</h3>
              <p className="text-xs text-[#6B6862]">
                Group spots by city, weekend trip, coffee crawl, or neighborhood.
              </p>
            </div>

            <div className="bg-[#FAF3E1] p-6 rounded-2xl border border-[#E8DECA] space-y-2">
              <div className="text-2xl font-black text-[#FA8112]">03</div>
              <h3 className="font-sans text-base font-extrabold text-[#222222]">Plan</h3>
              <p className="text-xs text-[#6B6862]">
                Mark spots as must-visit, want-to-visit, or already visited as you explore.
              </p>
            </div>

            <div className="bg-[#FAF3E1] p-6 rounded-2xl border border-[#E8DECA] space-y-2">
              <div className="text-2xl font-black text-[#FA8112]">04</div>
              <h3 className="font-sans text-base font-extrabold text-[#222222]">Share</h3>
              <p className="text-xs text-[#6B6862]">
                Send a clean, fast-loading link to friends without forcing an app download.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* 3. CORE VALUE PROPOSITION: SPOT DETAILS */}
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-5 space-y-4">
            ...
            <h2 className="font-sans text-3xl sm:text-4xl font-black text-[#222222] leading-tight">
              Notes, priorities, and real locations.
            </h2>
            <p className="text-sm text-[#6B6862] leading-relaxed">
              Don&apos;t just drop a pin &mdash; remember <em>why</em> you saved it. Add custom notes like &ldquo;order the matcha latte&rdquo; or &ldquo;great sunset view from the terrace.&rdquo;
            </p>
            <div className="space-y-2 pt-2 text-xs font-bold text-[#222222]">
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-[#FA8112]" />
                <span>Priority tags: Must Visit, Want to Visit, Maybe</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-[#FA8112]" />
                <span>Status tracking: Saved, Planned, Visited</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-[#FA8112]" />
                <span>Direct Google Maps link for each place</span>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-5 lg:order-2 space-y-4">
            ...
            <p className="text-sm text-[#6B6862] leading-relaxed">
              Invite your friends by @username. Add spots together, vote on places, and keep everyone on the same page.
            </p>
            <div className="space-y-2 pt-2 text-xs font-bold text-[#222222]">
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-[#222222]" />
                <span>Owner &mdash; full control over list and members</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-[#FA8112]" />
                <span>Editor &mdash; can add places, change status, and invite</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-[#6B6862]" />
